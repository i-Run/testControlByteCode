...
public class DependencyAnalysisBetweenLibraries extends ReadByteCodeClass<DependenceJarTest> {

  public DependencyAnalysisBetweenLibraries(DependenceJarTest control, Classe currentReadingClass) {
